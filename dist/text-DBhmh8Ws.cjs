"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const s=require("./input_utils-DfIJtBg6.cjs"),r=require("./theme-GIGh0eiy.cjs"),p=require("./generateCSS-BTiCx_G7.cjs");async function m({mode:n="input",value:o=""}={}){const i=n==="input"?`
<label>
