"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const a=require("./input_utils-DfIJtBg6.cjs"),g=require("./theme-wIK325iA.cjs"),v=require("./generateCSS-7cEUh0sF.cjs");async function m({mode:s="input",value:c="",disabled:p=!1}={}){const d=`
