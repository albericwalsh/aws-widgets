import { getThemeObject as o, cssVarsString as l } from "./theme-D01i-Ra9.js";
import { setThemeObject as w } from "./theme-D01i-Ra9.js";
function i(e = o()) {
  const a = e && e.widgets && e.widgets.table || {}, r = 20;
  let s = "";
  for (let t = 1; t <= r; t++)
    s += `::slotted(aws-table-row) > aws-table-cell:nth-child(${t}){width:var(--col-${t}-width, auto);}`;
  return `:host{${l(Object.assign({}, o().cssVars || {}, e && e.cssVars || {}))}}
        :host{display:block}
        .table{
            display:table;
            position: relative;
