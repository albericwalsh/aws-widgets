...
function r(t = e()) {
  const i = t && t.widgets && t.widgets["progress-circle"] || {};
  return `:host{${a(Object.assign({}, e().cssVars || {}, t && t.cssVars || {}))}}
        :host{ display:inline-block; --pc-size: 60px; --pc-color: ${i.color || "var(--color-text-primary, #fff)"}; }
