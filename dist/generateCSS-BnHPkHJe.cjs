"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const e=require("./theme-wIK325iA.cjs");function i(t=e.getThemeObject()){const a=t&&t.widgets&&t.widgets["progress-circle"]||{};return`:host{${e.cssVarsString(Object.assign({},e.getThemeObject().cssVars||{},t&&t.cssVars||{}))}}
        :host{ display:inline-block; --pc-size: 60px; --pc-color: ${a.color||"var(--color-text-primary, #fff)"}; }
    ...
    `}const r={generateCSS:i};exports.setTheme=e.setThemeObject;exports.default=r;exports.generateCSS=i;
