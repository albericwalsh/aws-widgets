"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const t=require("./theme-wIK325iA.cjs");function r(o=t.getThemeObject()){const a=t.cssVarsString(Object.assign({},t.getThemeObject().cssVars||{},o&&o.cssVars||{})),e=o.widgets.bool;return`:host{${a}}
    ...
    `}exports.setTheme=t.setThemeObject;exports.generateCSS=r;
