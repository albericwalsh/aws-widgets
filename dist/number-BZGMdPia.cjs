"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const r=require("./input_utils-DfIJtBg6.cjs"),d=require("./theme-wIK325iA.cjs"),y=require("./generateCSS-CTD7KfgL.cjs");async function b({mode:e="input",value:n="",disabled:s=!1}={}){const l=`
<label>
