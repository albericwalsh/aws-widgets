"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const u=require("./input_utils-DfIJtBg6.cjs"),b=require("./theme-wIK325iA.cjs"),y=require("./generateCSS-CoHJOGOP.cjs");async function S({mode:n="input",value:o="",disabled:l=!1}={}){const p=`
<label>
