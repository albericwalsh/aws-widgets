"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});function r(a){const e=a.widgets.search||{},t=a.widgets.button||{};return`
    ...
    .widget-search {
      ...
      width: ${e.width||"300px"};
      max-width: 90vw;
      background: ${e.background||"rgba(255,255,255,0.08)"};
      border-radius: 30px;
      overflow: hidden;
    ...
    :host([variant="secondary"]) .widget-search { background: ${t.secondaryBg||e.background}; }
    :host([variant="ghost"]) .widget-search { background: ${t.ghostBg||"transparent"}; }

    /* No size variations for search (controlled via parameters elsewhere) */
  `}const n={generateCSS:r};exports.default=n;exports.generateCSS=r;
