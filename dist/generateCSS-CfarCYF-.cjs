"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});function e(t){return`
        :host{ display:inline-block; --pc-size: 60px; --pc-color: ${(t&&t.widgets&&t.widgets["progress-circle"]||{}).color||"var(--color-text-primary, #fff)"}; }
    ...
    `}const i={generateCSS:e};exports.default=i;exports.generateCSS=e;
