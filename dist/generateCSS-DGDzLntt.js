function t(a) {
  const e = a.widgets.search || {}, r = a.widgets.button || {};
  return `
    ...
    :host([variant="secondary"]) .widget-search { background: ${r.secondaryBg || e.background}; }
    :host([variant="ghost"]) .widget-search { background: ${r.ghostBg || "transparent"}; }

    /* No size variations for search (controlled via parameters elsewhere) */
  `;
}
const s = { generateCSS: t };
export {
  s as default,
  t as generateCSS
};
