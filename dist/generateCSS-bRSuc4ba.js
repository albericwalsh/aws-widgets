import { getThemeObject as t, cssVarsString as o } from "./theme-D01i-Ra9.js";
import { setThemeObject as g } from "./theme-D01i-Ra9.js";
function n(e = t()) {
  const s = o(Object.assign({}, t().cssVars || {}, e && e.cssVars || {})), a = e.widgets.search || {}, r = e.widgets.button || {};
  return `:host{${s}}
    ...
    .widget-search {
      ...
      width: ${a.width || "300px"};
      max-width: 90vw;
      background: var(--aws-bg, ${a.background || "rgba(255,255,255,0.08)"});
      border-radius: 30px;
      overflow: hidden;
    ...
    :host([variant="secondary"]) .widget-search { background: var(--aws-bg, ${r.secondaryBg || a.background}); }
