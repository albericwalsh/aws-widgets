"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const s=require("./input_utils-DfIJtBg6.cjs"),v=require("./theme-wIK325iA.cjs"),y=require("./generateCSS-DIfvrlAY.cjs");async function b({mode:r="input",value:c="",disabled:l=!1}={}){const d=`
