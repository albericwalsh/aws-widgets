"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const o=require("./theme-wIK325iA.cjs");function a(e=o.getThemeObject()){return e&&e.widgets&&e.widgets.selector,`:host{${o.cssVarsString(Object.assign({},o.getThemeObject().cssVars||{},e&&e.cssVars||{}))}}
        :host{display:block}
        .selector{
    ...
    `}const s={generateCSS:a};exports.setTheme=o.setThemeObject;exports.default=s;exports.generateCSS=a;
