"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const t=require("./theme-wIK325iA.cjs");function o(r=t.getThemeObject()){const i=t.cssVarsString(Object.assign({},t.getThemeObject().cssVars||{},r&&r.cssVars||{})),e=r.widgets.slider;return`:host{${i}}
        :host {
    ...
    `}exports.setTheme=t.setThemeObject;exports.generateCSS=o;
